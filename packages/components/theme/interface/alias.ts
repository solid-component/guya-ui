...
export interface AliasToken extends MapToken {
   ...
   */
  linkDecoration: JSX.CSSProperties['text-decoration'];
  /**
   * @nameZH 链接鼠标悬浮时文本装饰
   ...
   */
  linkHoverDecoration: JSX.CSSProperties['text-decoration'];
  /**
   * @nameZH 链接聚焦时文本装饰
   ...
   */
  linkFocusDecoration: JSX.CSSProperties['text-decoration'];
